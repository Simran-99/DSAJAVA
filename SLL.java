public class SLL {
    ...
    public static void main(String args[]) {
        SLL Single_list=new SLL();
        Single_list.isEmpty();
        System.out.println("Peration:Insering elements in List at Beginning");
        System.out.println("-----------*-----------*-----------*-----------");
        Single_list.insert_beginning(2);
        Single_list.insert_beginning(1);
        ...
        System.out.println("-----------*-----------*-----------*-----------");
        Single_list.insert_end(3);
        Single_list.insert_end(4);
        System.out.println("Operation: Printing Elements from the list");
        Single_list.print_list();
        System.out.println("-----------*-----------*-----------*-----------");
        System.out.println("Searching an item");
        
        Single_list.search(3);
        Single_list.search(10);
        System.out.println("-----------*-----------*-----------*-----------");
        System.out.println("Operation: insert element in beginning");
        System.out.println("-----------*-----------*-----------*-----------");
        Single_list.insert_after_node(3,8);
        System.out.println("Operation: Printing Elements from the list");
        Single_list.print_list();
